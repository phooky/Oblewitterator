...
module pulley_bracket() {
	...
	union() {
	    hull() {
		translate([0,0,-32]) cube(size=[blen,40,5],center=true);
		translate([0,outer_y+4,-32]) cube(size=[30,8,5],center=true);
	    }
	    hull() {
		translate([0,0,-31]) cube(size=[6,8,7],center=true);
		...
		hull() {
		    ...
		    rotate([90,0,0]) cylinder(d=16,h=8,center=true);
		    translate([0,0,-31]) cube(size=[30,8,7],center=true);
		}
	    }
	    translate([0,inner_y-4,0]) {
		hull() {
		    translate([0,0,pulley_rise])
		    rotate([90,0,0]) cylinder(d=16,h=8,center=true);
		    translate([0,0,-31]) cube(size=[30,8,7],center=true);
